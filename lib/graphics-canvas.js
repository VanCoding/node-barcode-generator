/*!
 * Barc - Graphics
 * Copyright (c) 2013 Cristóbal Maldonado <cristobal.maldonado@gmail.com>
...
Graphics.prototype.fillText = function(text, x, y){
	...
	this.fillBgRect(left-this.font_size, top-3, bounds.width+this.font_size*2, this.font_size+3);
	this.ctx.fillStyle = this.fg;
	this.ctx.fillText(text, left, this.height-3);
